...
export const WholesaleForm: Link = { name: "Wholesale Order Form", path: "/wholesale-form" };
export const WholesaleOrders: Link = { name: "Wholesale Orders", path: "/wholesale-orders" };
export const RetailOrders: Link = { name: "Retail Orders", path: "/retail-orders" };
export const Production: Link = { name: "Daily Production", path: "/production" };
...
export const isLink = (value: unknown): value is Link => {
  return typeof value === "object" && value !== null && "name" in value && "path" in value && typeof (value as Link).name === "string" && typeof (value as Link).path === "string";
}
