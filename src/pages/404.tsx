      ...
      <Card className="overflow-visible mb-14">
        <CardHeader>
          <h1 className="font-bold">
            <mark className="p-1 bg-destructive/10 text-destructive">404</mark>{" "}
            - Not Found
          </h1>
        </CardHeader>
        <CardContent className="space-y-6 text-center flex place-items-center flex-col">
          ...
          <div className="relative mb-6">
            <InputGroup>
              ...
              <Card
                className={`w-full p-0 absolute top-full h-fit max-h-32 overflow-y-auto scrollbar-gutter-both flex ${showResults ? "z-10" : "-z-10"}`}
              >
